...
parser = argparse.ArgumentParser(description="Latex Math Problem Solver")
parser.add_argument("question", help="latex math probelm you want to solve")
...
# problem = "Find all the rational roots of\n\\[2x^3 - 9x^2 - 32x - 21 = 0.\\]Enter all the rational roots, separated by commas" 
...
print("\n", "-"*60, f"\n\nThe answer is... {extract_last_boxed_text(messages[-1]['content'])}")
